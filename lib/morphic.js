...
var DocGenerator = /** @class */ (function () {
    ...
    DocGenerator.prototype.addParameterTypeDocs = function (parameterType) {
        ...
        if (parameterType.isObject()) {
            this.addObjectDocs(parameterType);
        }
    };
    DocGenerator.prototype.addObjectDocs = function (objectParam) {
        // Complete me
        var name = objectParam.getText();
        objectParam.getProperties().forEach(function (prop) {
