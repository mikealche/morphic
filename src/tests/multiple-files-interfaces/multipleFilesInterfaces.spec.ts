    ...
    expect(docGenerator.classDocs).toEqual([
      {
        ...
        location:
          "/Users/mike/os/testmorph/src/tests/multiple-files-interfaces/classContainer2.ts",
        properties: [
      ...
      },
      {
        ...
        location:
          "/Users/mike/os/testmorph/src/tests/multiple-files-interfaces/classContainer.ts",
        methods: [],
      },
      {
        className: "Animal",
